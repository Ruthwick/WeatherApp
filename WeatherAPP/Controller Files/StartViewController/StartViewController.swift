...
class StartViewController: UIViewController{
    ...
    @IBAction func continueButtonPressed(_ sender: UIButton) {
        guard let controller = storyboard?.instantiateViewController(withIdentifier: APPConstants.weatherViewController) as? WeatherViewController else { return }
    ...
    private func updateUI() {
        ...
        self.greetingsLabel.text = "Welcome!"
        self.descriptionLabel.text = "The app provides accurate forecast and weather alerts wherever you are. We must be allowed to use your Location Services."
