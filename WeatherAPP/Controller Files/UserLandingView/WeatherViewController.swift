...
class WeatherViewController: UIViewController {
    ...
    @IBAction func searchButtonPressed(_ sender: UIBarButtonItem) {
        guard let controller = storyboard?.instantiateViewController(withIdentifier: APPConstants.searchViewController) as? SearchViewController else { return }
...
extension WeatherViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == hourlyCollectionView {
            ...
            guard let hourlyCell = hourlyCollectionView.dequeueReusableCell(withReuseIdentifier: APPConstants.cells.hourlyCollectionViewCell, for: indexPath) as? HourlyCollectionViewCell
            ...
            guard let dailyCell = dailyCollectionView.dequeueReusableCell(withReuseIdentifier: APPConstants.cells.dailyCollectionViewCell, for: indexPath) as? DailyCollectionViewCell
            else { return UICollectionViewCell ()}
